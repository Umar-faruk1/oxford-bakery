...
import { ChevronLeft, ChevronRight, Home, LayoutDashboard, Users, ShoppingCart, Menu, Bell, Truck, Settings, LogOut } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-16 px-4">
        <div className={`${!isOpen && "hidden"} flex items-center space-x-2`}>
